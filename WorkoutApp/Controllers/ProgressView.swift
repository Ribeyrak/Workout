...
extension TimerView {
    final class ProgressView: UIView {
        func drawProgress(with percent: CGFloat) {
            ...
            let defualtCicrleLayer = CAShapeLayer()
            defualtCicrleLayer.path = circlePath.cgPath
            defualtCicrleLayer.strokeColor = R.Colors.separator.cgColor
            defualtCicrleLayer.lineWidth = 20
            defualtCicrleLayer.strokeEnd = 1
            defualtCicrleLayer.fillColor = UIColor.clear.cgColor
            defualtCicrleLayer.lineCap = .round
            ...
            layer.addSublayer(defualtCicrleLayer)
